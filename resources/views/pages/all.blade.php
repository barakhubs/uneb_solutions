            ...
            <div class="row g-0 gx-5 align-items-end">
                <div class="col-lg-6 mb-3">
                    <div class="text-start mx-auto mb-2">
                        <h4 class="mb-3">Resource Listing for {{ $keyword.': '.$title }}</h4>
                        <p>Welcome to PSS education resource center</p>
                    </div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                            <li style="text-transform: capitalize" class="breadcrumb-item"><a href="{{ route('all-resources', [$keyword, $slug])}}">{{ $keyword }}</a></li>
                            <li style="text-transform: capitalize" class="breadcrumb-item active" aria-current="page">{{ $title }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
